...
apt-get install -y parted openssh-server bash-completion cifs-utils curl dbus dosfstools firmware-linux-free gddrescue gdisk iputils-ping isc-dhcp-client less nano network-manager nfs-common ntfs-3g openssh-client open-vm-tools procps wimtools wget
